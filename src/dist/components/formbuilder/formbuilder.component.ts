...
export class FormBuilderComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    Formio.builder(this.builderElement.nativeElement, this.form, this.options).then((instance) => {
      ...
      instance.on('formLoad', (component: any) => {
        console.log('formLoad', component);
      }
      );

      //Submit form event
      instance.on('submit', (component: any) => {
        console.log('submit', component);
      }
      );
      

      instance.on('editComponent', (component: any) => {
      ...
      instance.on('cancelComponent', (Component: any) => {
        console.log('cancelComponent', Component);
      })
